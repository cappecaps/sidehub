...
In this Colab notebook I compared the returns of value-weighted (or market-cap-weighted) and equal-weighted index funds.

I plan to re-write it on this page. In the meantime, you can find it here:
